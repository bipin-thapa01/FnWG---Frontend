        ...
        <div className='flex flex-col gap-y-14 items-center'>
          ...
          <form className='flex flex-col gap-y-6 w-screen md:w-lg pl-2 pr-2' onSubmit={submitForm}>
            ...
            <div className='flex flex-col'>
              ...
              <input type='text' placeholder='Enter your email' autoComplete='off' name='username' className='rounded-lg overflow-hidden p-2' style={{ border: '1px solid #696969' }} />
            </div>
            <div className='flex flex-col'>
            ...
            <div className='text-sm text-gray-500'>Already have an account? <span className='text-blue-500 cursor-pointer' onClick={() => router.push('/signin')}>Sign In</span></div>
          </form>
        </div>
      </div>
